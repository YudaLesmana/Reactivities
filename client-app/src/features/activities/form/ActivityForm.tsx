...
export default observer(function ActivityForm() {
    ...
    function handleFormSubmit(activity: Activity) {
        if(activity.id.length === 0) {
            ...
            createActivity(newActivity).then(() => hinstory.push(`/activities/${newActivity.id}`))
        } else {
            updateActivity(activity).then(() => hinstory.push(`/activities/${activity.id}`))
        }
    }
